...
To kick of this December, I have decided to deliver a missing present to [Skymallhomevideorentalservice
](https://www.tumblr.com/blog/smallwolfcollective) from [Secret Santicorn 2024](@/christmas_in_july_2025/index.md).

## The Prompt

> d66 largely useless cyberpunk treasures, from least valuable to most valuable

<!-- more -->

## A d66 of Cyberpunk Treasures

### 1. Another man's trash...

1. Trick marble. When flicked, can change trajectory. Needs hacked to determine the trajectory change.
2. A tiny droid with many loud whirring servo motors that wipes crumbs from your mouth. Napkin not included.
3. Plasma cutter bottle opener. Unable to fit anything but a bottle or maybe a can, and drains its energy source quickly.
4. A faulty rusty battle droid that cannot aim and was clearly used as a coat rack.
5. An overly eager bouncy, bitey, automated paper shredder.
6. LED fidget spinner that powers up nearby (essentially adjacent) remote devices as long as it spins. A weak battery charger.
...
4. **Lucky Cat Figurine**
    - A gaudy lucky cat figurine with waving hand.
        ...
        When allowed to wave its hand, tech has a 20% chance of glitching around it.
        50% of successfully glitched tech will be hacked and accessible to the hidden computer within the cat, allowing the cat to be used as a tunnel for access to that tech.
        The cat has a virtual backdoor easily accessible by any with wireless radios who identify the cat and attempt to access it.
5. **Fancy Cane Gun**
...
4. **B0RG Visor 9000**
    - A large clunky looking B0RG branded visor that easily and comfortably fits on the users face, syncs to their brain waves or existing cybernetics and provides all the different types of vision on mental command.
    With every use, there is a chance of a glitch.
    The first glitch, the visor band tightens and locks onto the user's head inserting neural spikes to connect to their brain for "direct interfacing".
    It cannot be removed without expert help and every use and attempt to remove risks a glitch that further "improves the direct interface".
    Direct interfacing does deal damage, but the vision quality improves!
    Aiming and precision when using the visor improves greatly while the direct interface is connected.
    Odds increase for glitch with each use, similar to HAL 2077.
5.
6.
...
1. **My Moon**
    An incredibly rare virtual reality space of the Earth's moon, in part an advertising product for moon miners and researchers, and otherwise a decent explore and craft video game.
    The save file is called, "My Moon".
    All users are able to breath, it is a simulation for entertainment and exploration.
    In one of the nearby craters at spawn point, there is a station branded with the Megacorp's logo who made the VR space.
    In it, besides loot boxes and a marketplace, are some boxes containing prior materials from the last player, along with some logs and personal trinkets they either found or made themselves.
    You can tell the past owner played this often, having mapped out the moon and detailed logs of their activities.
    Across this virtual moon, players will often encounter tracks and evidence of the past user being where they are. A 1d6 of possible
    1. There are moon rover or space suit tracks to and from this place.
    2. An unlocked equipment box containing materials from the local area, in particular moon rocks, moon dust, and spare mining equipment. 5% chance of a moon diamond.
    3. The area has been extensively dug out in a haphazard manner.
    4. A small workshop with equipment chests full of (virtual) resources and loot and the factory machines to process those resources.
    5. A looping recorded replay of the user's play time in this area.
    6. Personal diary entries are painstakingly written in some form in this location, not always a simple text log.
2. A complete self-record of a chrome head's decent into cyber psychosis recorded as video logs with written logs of the cybernetic specifications of implants and medicine used.
