...
With that list of posts, the current map is as seen below with my currently proposed four hexes added to the map.

<img
    src="hexes_as_of_2025-12-05_and_mine_sml.jpg"
    alt="Sketch of the current Hexmas map with digital edits for clarity."
    style="display:block; margin-left: auto; margin-right: auto;"
    loading="lazy"
    decoding="async"
/>

The hexes for "The Island of Misfit Toys" and "King Kringle" currently do not have assigned neighbors, while the rest result in the current form given their stated neighbors in the blog posts.
...
|Ref. #|Blog|Blog Post| Date <br/> YY/MM/DD |
|---|---|---|---|
1| Magnolia Keep | [Orcish Toy Factory](https://magnoliakeep.blogspot.com/2025/11/blog-bandwagon-orcish-toy-factory.html) | 2025/11/03
2| To Be Resolved | [Snow Miser's Houseboat](https://tbr.bearblog.dev/merry-hexmas-blog-bandwagon-snow-misers-houseboat/) | 2025/11/03
3| Meadow of the Witch-Hares | [The Chapel of the Green](https://meadowofthewitch-hares.blogspot.com/2025/11/the-chapel-of-green-hexmas-blogwagon.html) | 2025/11/04
4| Fluorite Guillotine | [Broken Bronco on the Silver Steppe](https://www.fluoriteguillotine.com/blog/2025/11/08/blogwagon-broken-bronco-on-the-silver-steppe/) | 2025/11/08
5| King Kringle	| [Dieku Games](https://diekugames.com/merry-hexmas/) | 2025/11/15
6| Peasantry | [The Seven Levels of the Candy Cane Forest](https://muto2525.substack.com/p/the-seven-levels-of-the-candy-cane) | 2025/11/22
...
1. [**Sleeping Slopes**](@/sleeping_slopes/index.md)
...
2. [**Vorpal Vale**](@/vorpal_vale/index.md): A valley between Sleeping Slopes to the north and Rime Ridge to the south. The fog often pours from the mountains into the valley which features a small river weaving between its slopes.
...
3. [**Rime Ridge**](@/rime_ridge/index.md): A misty mountain range featuring a prominent mountain ridge and Blind Man's Bluff, which overlooks the "Swirly Twirly Sea of Gumdrops".
Many places are hidden among these rime covered mountains.
4. [**Powder Plains**](@/powder_plains/index.md): A mostly peaceful flat snow field that features a few towns within this North Pole.
...
I am introducing quite a few wandering characters that either hail from these hexes or are known to wander through them and even other hexes made by others, as befitting their ability and the existence of a path which enables someone of their ability to commit to such journeys.
I also note any references or rumors I leave up for others to do with what they will.


## Roaming Characters Across All Hexes

All Hexes including those made by others in so far as would make sense for them to reach, visit, or travel through in this world.
...
A bard Snow Elemental who travels from settlement to settlement sharing news and performing light deliveries.
...
**Clockwork horrors** tirelessly hunt across all of the North Pole for "Happy New Year" to be returned to the current Father Time, of "The Dark Year" back at his Palace of Time.
    - These twisted clocks tick-tock on the dot. They are precise, exact automata.

<img
    src="general_ticker.jpg"
    alt="Frame of General Ticker from Rudolph's Shiny New Year."
    style="display:block; margin-left: auto; margin-right: auto; width: 80%;"
    loading="lazy"
    decoding="async"
/>
...
<img
    src="ruprecht_belsnickle_stare_down_sml.jpg"
    alt="Sketch of Ruprech Belznickle stepping on a stone looking down at viewer."
    style="display:block; margin-left: auto; margin-right: auto; width: 80%;"
    loading="lazy"
    decoding="async"
/>

- Ruprecht Belznickle is a [hulderálfar](@/the-elves-revolt.md#the-hulderalfar), the original Christmas Elves of yore.
...
- Rather unique to him, his eyes are like star fields on the pitch black of space.
...
<img
    src="ruprecht_belsnickle_profile_red-cap_sml.jpg"
    alt="Sketch of Ruprech Belznickle profile of face wearing redcap."
    style="display:block; margin-left: auto; margin-right: auto; width: 80%;"
    loading="lazy"
    decoding="async"
/>
...
## Roaming Characters Across Only These Four Hexes

These characters have reason to be bound within these four hexes, although are free to be used by others!

- **Aeon the Great Vulture**
    - Just tends to fly and hunt in these hexes.
    - Secrets:
        - He does not hunt for "Happy" New Year.
        - His eon is not at risk this new years or even soon.

<img
    src="Aeon_the_Terrible.webp"
    alt="Frame of Aeon the terrible vulture from Rudolph's Shiny New Year."
    style="display:block; margin-left: auto; margin-right: auto; width: 80%;"
    loading="lazy"
    decoding="async"
/>
...
- **"The Dark Year"**
    ...
    - They are said to be hunting for the missing next New Year baby "Happy".
...
1. [Sleeping Slopes](@/sleeping_slopes/index.md)
2. [Vorpal Vale](@/vorpal_vale/index.md)
3. [Rime Ridge](@/rime_ridge/index.md)
4. [Powder Plains](@/powder_plains/index.md)
